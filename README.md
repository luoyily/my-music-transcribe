...
本项目中的工程采用[署名-非商业性使用-相同方式共享 4.0 国际 (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)进行许可。
...
| 2    | Other side of sadness    | 天門           | eden* They were only two, on the planet. |      |              | 0.95       | 仅钢琴轨，有添加部分note，未与原曲绝对对齐 |
| 3    | Summer Pockets           | 水月陵         | Summer Pockets                           |      |              | 0.95       | 未与原曲绝对对齐                           |
| 4    | PIANO                    | 天門           | Trinoline                                |      |              | 1          |                                            |
...
| 序号 | 曲名           | 原艺术家  | 相关作品 | Midi | Muse Score 4 | 备注     |
| ---- | -------------- | --------- | -------- | ---- | ------------ | -------- |
| 1    | 祭神纸偶与愿望 | 松本 文紀 | GINKA    |      |              | 钢琴改编 |
|      |                |           |          |      |              |          |
